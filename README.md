---
website: "Portal da Bolsa de Emprego de Câmara de Lobos"          # Entre as aspas escreve o nome do website
date: "20/05/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://bolsadeemprego.cm-camaradelobos.pt"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://bolsadeemprego.cm-camaradelobos.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
...
<details>
  ...
  <ul aria-label="lista de relatórios já efetuados">
    <li><a href="20052026_report.html">(20/05/2026). Relatório {{ page.website }}</a></li>
  </ul>
</details>
